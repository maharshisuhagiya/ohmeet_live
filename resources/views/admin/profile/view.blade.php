                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <div class="media align-items-center mb-4">
                                ...
                                <div class="media-body">
                                    <h3 class="mb-0" id="full_name_val">{{isset($full_name)?$full_name:''}}</h3>
                                </div>
                            </div>
                            @if($user->mobile_no != "")
                ...
                <form class="form-valide" action="" id="userform" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group ">
                            ...
                            <div>
                                <label class="radio-inline mr-3"><input type="radio" name="gender" value="1" checked> Male</label>
                                <label class="radio-inline mr-3"><input type="radio" name="gender" value="2"> Female</label>
                            </div>
